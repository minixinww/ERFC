# ERFC
We developed an XGBoost model, Model 1A-M, based on c_ECFP4 to classify the feasibility of enzymatic reactions. This model can handle both stereochemistry-preserving and stereochemistry-agnostic reactions, enabling efficient and rapid screening of large-scale biosynthetic reactions.
