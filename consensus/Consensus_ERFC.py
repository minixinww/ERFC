...
class ConsensusModel:
    ...
    def run(self, output_file):
        ...
        print("========== Consensus_ERFC Model started ==========")
        ...
        if not (
            df1["Reaction"].equals(df2["Reaction"])
            and
            df1["Reaction"].equals(df3["Reaction"])
            and
            df1["Reaction"].equals(df4["Reaction"])
        ):
        ...
        print("========== Consensus_ERFC Model completed ==========")
